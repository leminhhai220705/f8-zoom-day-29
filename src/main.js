...
//               <img src="${product.thumbnail}" alt="" />
//             </figure>
//             <div class="thumbnails thumbnails-3">
//               <figure class="thumbnails__img">
//                 <img src="../../public/product-1.jpg" alt="" />
//               </figure>
//               <figure class="thumbnails__img">
//                 <img src="../../public/product-1.jpg" alt="" />
//               </figure>
...
//                 <div class="total-price">
//                   <strong class="price">$${product.price}</strong>
//                   <div class="discount cart-sale"><strong>${product.discountPercentage}% OFF</strong></div>
//                 </div>
...
//               <section class="brand">
//                 <h2 class="brand__heading">Brand</h2>
//                 <p class="brand__info">${product.brand}</p>
//               </section>
//               <section class="sku">
//                 <h2 class="sku__heading">SKU</h2>
//                 <p class="sku__info">${product.sku}</p>
...
//                 <div class="dimension-metric">
//                   <p class="dimension__width">${product.dimensions.width} mm</p>
//                   <p class="dimension__height">${product.dimensions.height} mm</p>
//                 </div>
//               </section>
//               <section class="depth">
//                 <h2 class="depth__heading">depth</h2>
...
//               <section class="warranty-info">
//                 <h2 class="warranty-info__heading">warranty information</h2>
//                 <p class="warranty-info__info">${product.warrantyInformation}</p>
//               </section>
//               <section class="shipping-info">
//                 <h2 class="shipping-info__heading">shipping information</h2>
//                 <p class="shipping-info__info">${product.shippingInformation}</p>
//               </section>
//             </div>
//             <div class="confirm-btn">
//               <button class="btn cart-adding">Add to Cart</button>
...
//                     <time class="time" datetime="">April 22, 2024</time>
//                   </div>
//                 </div>
...
//                 consequatur doloribus quam totam ducimus, sapiente consequuntur
//               </p>
//             </div>
...
//                 <div class="create-at">
//                   <p>Create At</p>
//                   <time datetime="">${product.meta.createdAt}</time>
//                 </div>
//                 <div class="update-at">
//                   <p>Update At</p>
//                   <time datetime="">${product.meta.updatedAt}</time>
//                 </div>
//               </div>
//             </section>
//             <div class="code">
